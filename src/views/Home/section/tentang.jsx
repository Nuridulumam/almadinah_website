...
const Tentang = ({ title, subtitle, image, ctaLink, ctaText }) => {
  return (
    <Box>
      <SectionTitle
        setID="about"
...
Tentang.defaultProps = {
  ...
  subtitle:
    "Pondok Pesantren Al Madinah adalah sebuah pondok putra/putri yang terdiri dari Pesantren Putra Darul Iman, Pesantren Putri Umi Kulsum Adnan, SMP, dan MA yang terletak di Kecamatan Diwek, Jombang",
  image: imgJumbotron,
  ctaText: "Daftar",
  ctaLink: "/psdb",
};
